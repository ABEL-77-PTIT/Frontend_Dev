  ...
  return (
    <nav className="flex items-center ">
      ...
      <ul className="md:flex md:gap-10 ml-auto text-16 font-semibold">
        ...
        {openMenu && (
          <div className="absolute right-8 w-80 bg-white p-8 text-center z-10 text-black text-13">
            <li className="cursor-pointer my-4">Features</li>
            <li className="cursor-pointer my-4">Menu </li>
            <li className="cursor-pointer my-4">Our Story</li>
            <li className="cursor-pointer my-4">Contact</li>
          </div>
        )}
      </ul>
    </nav>
