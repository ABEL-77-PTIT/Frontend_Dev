      ...
      <div className="position__container">
        <div className="position__content">
          <div className="position__desc">
            ...
            <p>
              Mona Citi Land toạ lạc tại ngay trung tâm khu đô thị Cát Lái quận
              2. Chỉ cần không quá 15 phút di chuyển khách hàng có thể kết nối
              tất cả các tiện ích lân cận, tất cả những quận lân cận và quận 1.
              Trường học, bệnh viện, siêu thị, khu vui chơi giải trí, công viên
              kề bên…Citialto giúp bạn hiện thực ước mơ có 1 căn nhà ngay trung
              tâm thành phố, phù hợp trở thành một nơi an cư lý tưởng.
            </p>
          </div>
          ...
          {positions.map((position) => {
            return (
              <div key={position.title} className="position__details">
                <h3>
                  <span><AiFillPlusSquare /></span>
                  {position.title}
                </h3>
                <p>{position.desc}</p>
              </div>
