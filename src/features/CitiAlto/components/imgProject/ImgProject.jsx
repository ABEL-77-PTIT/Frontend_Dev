        ...
        <div className="imgProject__content">
          ...
          <div className="img__content--tabs">
                    ...
                    {apartment.map((apart) => {
                      return (
                        <div className="apartImg">
                          <img src={apart} alt="Ảnh nè" />
                        </div>
                      );
                    })}
                  </Slider> */}
                  {/* <div className="apartImg">
                    <img src="http://mauweb.monamedia.net/canhocitialto/wp-content/uploads/2019/02/gall1.jpg" alt="Ảnh nè" />
                  </div> */}
                <div className="apartment__center--bottom1">
                </div>
                <div className="apartment__center--bottom2">
                </div>
                <div className="apartment__center--bottom3">
                </div>
            ...
            >
              ...
              Slider       {othersUtilities.map((otherUtilities) => {
                  return (
                    <div className="otherUtilities">
                      <img src={otherUtilities} alt="Ảnh nè" />
                    </div>
                  );
                })}
              </Slider>
